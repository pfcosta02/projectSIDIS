...
public class ProductController {
    ...
    public Iterable<ProductNameView> findBySku(@PathVariable(value =  "sku" )String sku) {
        ...
        if(service.findBySku(sku).isEmpty()) {
           ...
           List<ProductNameView> products = response.getBody();
    ...
    public ResponseEntity<AggregatedRating> getProductRating(@PathVariable("productId") final Long productId) {
